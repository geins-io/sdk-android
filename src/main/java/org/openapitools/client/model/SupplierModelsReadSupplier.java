...
public class SupplierModelsReadSupplier {
   ...
   **/
  @ApiModelProperty(value = "The unique identifier for the supplier.")
  ...
  public boolean equals(Object o) {
    ...
    SupplierModelsReadSupplier supplierModelsReadSupplier = (SupplierModelsReadSupplier) o;
    return (this.supplierId == null ? supplierModelsReadSupplier.supplierId == null : this.supplierId.equals(supplierModelsReadSupplier.supplierId)) &&
        (this.name == null ? supplierModelsReadSupplier.name == null : this.name.equals(supplierModelsReadSupplier.name)) &&
        (this.address1 == null ? supplierModelsReadSupplier.address1 == null : this.address1.equals(supplierModelsReadSupplier.address1)) &&
        (this.address2 == null ? supplierModelsReadSupplier.address2 == null : this.address2.equals(supplierModelsReadSupplier.address2)) &&
        (this.address3 == null ? supplierModelsReadSupplier.address3 == null : this.address3.equals(supplierModelsReadSupplier.address3)) &&
        (this.zipCode == null ? supplierModelsReadSupplier.zipCode == null : this.zipCode.equals(supplierModelsReadSupplier.zipCode)) &&
        (this.country == null ? supplierModelsReadSupplier.country == null : this.country.equals(supplierModelsReadSupplier.country)) &&
        (this.contactPerson == null ? supplierModelsReadSupplier.contactPerson == null : this.contactPerson.equals(supplierModelsReadSupplier.contactPerson)) &&
        (this.phone1 == null ? supplierModelsReadSupplier.phone1 == null : this.phone1.equals(supplierModelsReadSupplier.phone1)) &&
        (this.phone2 == null ? supplierModelsReadSupplier.phone2 == null : this.phone2.equals(supplierModelsReadSupplier.phone2)) &&
        (this.email == null ? supplierModelsReadSupplier.email == null : this.email.equals(supplierModelsReadSupplier.email)) &&
        (this.externalId == null ? supplierModelsReadSupplier.externalId == null : this.externalId.equals(supplierModelsReadSupplier.externalId));
  }
